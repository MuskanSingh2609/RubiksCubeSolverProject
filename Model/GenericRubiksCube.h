...
//
// Created by Muskan Singh on 18-01-2024.
//

#ifndef RUBIKSCUBESOLVERV1_GENERICRUBIKSCUBE_H
#define RUBIKSCUBESOLVERV1_GENERICRUBIKSCUBE_H
...
public:
    enum class FACE{// ENUM FOR CREATING A FIXED OPTION SET
        UP,
        LEFT,
        FRONT,
        RIGHT,
...
#endif //RUBIKSCUBESOLVERV1_GENERICRUBIKSCUBE_H
