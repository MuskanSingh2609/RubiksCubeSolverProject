...
class RubiksCube1dArr: public GenericRubiksCube {
private:
...
public:
    ...
    bool operator==(const RubiksCube1dArr &r1) const {
        for (int i = 0; i < 54; i++) {
    ...
    RubiksCube1dArr &operator=(const RubiksCube1dArr &r1) {
        for (int i = 0; i < 54; i++) {
            cube[i] = r1.cube[i];
        }
        return *this;
...
struct Hash1d {
    size_t operator()(const RubiksCube1dArr &r1) const {
        string str = "";
